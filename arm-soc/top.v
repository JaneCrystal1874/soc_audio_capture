...
module top(
  ...
  output wire  [1:0]    SDRAM_DQM
   ...
   /*
    * LEDR0 and LEDR1 are controlled by GPIOA[0] and GPIOA[2].
    * Drive LEDR2~LEDR9 low explicitly; otherwise Quartus may reserve the
    * unconnected LED pins in a board-visible state after programming.
    */
