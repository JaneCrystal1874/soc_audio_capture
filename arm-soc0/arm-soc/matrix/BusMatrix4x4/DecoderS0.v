...
//------------------------------------------------------------------------------
  ...
  BusMatrix4x4_default_slave u_BusMatrix4x4_default_slave (
...
//  lower bound of decode_addr_dec[31:10], which is not a hex character boundary
  ...
  always @ (
    ...
    begin : p_addr_out_port_comb
      ...
      else if (((decode_addr_dec >= (32'h40000000 >> 10)) & (decode_addr_dec <= (32'h5fffffff >> 10)))
                           | ((data_out_port == 3'b001) & (trans_dec == 2'b00)))
        addr_out_port = 3'b001;  // Select Output port MI1

      // Address region 0x60000000-0x6fffffff
      else if (((decode_addr_dec >= (32'h60000000 >> 10)) & (decode_addr_dec <= (32'h6fffffff >> 10)))
                           | ((data_out_port == 3'b010) & (trans_dec == 2'b00)))
        addr_out_port = 3'b010;  // Select Output port MI2

      // Address region 0x80000000-0x8fffffff
      else if (((decode_addr_dec >= (32'h80000000 >> 10)) & (decode_addr_dec <= (32'h8fffffff >> 10)))
